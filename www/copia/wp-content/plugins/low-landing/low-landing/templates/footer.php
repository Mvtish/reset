                    ...
                    <div class="ll-footer__inner">
                        ...
                        <div class="ll-footer__col ll-footer__col--nav">
                            ...
                            <ul class="ll-footer__menu">
                                <li><a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e('HOME', 'low-landing'); ?></a></li>
                                <li><a href="<?php echo esc_url(home_url('/quienes-somos/')); ?>"><?php esc_html_e('¿QUIÉNES SOMOS?', 'low-landing'); ?></a></li>
                                <li><a href="<?php echo esc_url(home_url('/contacto/')); ?>"><?php esc_html_e('CONTACTO', 'low-landing'); ?></a></li>
                                <li><a href="<?php echo esc_url(home_url('/protocolos/')); ?>"><?php esc_html_e('PROTOCOLOS', 'low-landing'); ?></a></li>
                                <li><a href="<?php echo esc_url(home_url('/vuelos/')); ?>"><?php esc_html_e('VUELOS', 'low-landing'); ?></a></li>
                            </ul>
                        </div>
